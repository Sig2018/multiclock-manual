# Manual de uso — Reloj Multiclock (Boca)
...
- **Modo Boca**: muestra la hora y la cuenta regresiva al próximo partido de Boca Juniors o de la Selección Argentina (el que esté más cerca).
...
El reloj suena cada una hora en punto (por ejemplo 9:00, 10:00, 11:00...), solo en horario diurno (entre las 9:00 y las 23:00). Fuera de ese rango se mantiene en silencio automáticamente, sin que tengas que hacer nada.
...
2. Va a aparecer una pantalla que dice "MODO SUBIDA" con una dirección IP y un botón para cambiar de modo:
   ...
   ![Pantalla de cambio de modo](img/cambiar_modo_boca.png)

3. Tocá el botón que dice **"Cambiar a F1"** o **"Cambiar a Boca"** (el texto cambia según el modo actual).
...
4. Tocá el botón **"Cambiar a F1"** / **"Cambiar a Boca"**.
